      ...
      <div className='max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border-[1px]
        ...
        <form action="" onSubmit={handleSignup} className='w-[90%] h-[90%] flex flex-col items-center justify-start
          ...
          <div className='w-[90%] h-[400px] flex flex-col items-center justify-center
            ...
            {!show && <IoEyeOutline className='w-[20px] h-[20px] cursor-pointer absolute right-[35%]'
              onClick={() => setShow(prev => !prev)} />}
            {show && <FaRegEyeSlash className='w-[20px] h-[20px] cursor-pointer absolute right-[35%]'
              onClick={() => setShow(prev => !prev)} />}

            <button className='w-[100%] h-[50px] bg-[#6060f5] rounded-lg flex items-center 
                justify-center mt-[20px] text-[17px] font-semibold'>
              Create Account</button>
            <p className='flex gap-[10px]'>You have any account?<span className='text-[#5555f6cf]
