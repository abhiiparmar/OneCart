      ...
      <div className='max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border-[1px]
        ...
        <form action="" onSubmit={handleLogin} className='w-[90%] h-[90%] flex flex-col items-center justify-start
          ...
          <div className='w-[90%] h-[400px] flex flex-col items-center justify-center
            ...
            {!show && <IoEyeOutline className='w-[20px] h-[20px] cursor-pointer absolute right-[35%] bottom-[35%]'
              onClick={() => setShow(prev => !prev)} />}
            {show && <FaRegEyeSlash className='w-[20px] h-[20px] cursor-pointer absolute right-[35%] bottom-[35%]'
              onClick={() => setShow(prev => !prev)} />}
            ...
            <p className='flex gap-[10px]'>You haven't any account?<span className='text-[#5555f6cf]
                 text-[17px] font-semibold cursor-pointer' onClick={() => navigate("/signup")}>Create new account</span></p>
          </div>
        </form>
      </div>
    </div>
