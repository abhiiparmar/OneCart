  ...
  return (
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white'>
      ...
      <div className='w-[100%] h-[100%] flex items-center justify-start'>
        ...
        <div className='w-[82%] h-[100%] lg:ml-[320px] md:ml-[230px] mt-[70px] flex flex-col 
...

          {
            list?.length > 0 ? (
              list.map((item, index) => (
                <div
                  className="w-[90%] md:h-[120px] h-[90px] bg-slate-600 rounded-xl
        flex items-center justify-start gap-[5px] md:gap-[30px] p-[10px] md:px-[30px]"
                  key={index}
                >
                  <img
                    src={item.image1}
          ...
          md:hover:bg-red-300 md:hover:text-black cursor-pointer' onClick={() => removeList(item._id)}>✗</span>
                  </div>
                </div>
              ))
            ) : (
