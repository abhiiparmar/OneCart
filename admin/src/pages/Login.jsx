    ...
    <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025]
     text-[white] flex flex-col items-center justify-start'>
      ...
      <div className='max-w-[600px] w-[90%] h-[400px] bg-[#00000025] border-[1px]
        ...
        <form action="" onSubmit={AdminLogin} className='w-[90%] h-[90%] flex flex-col items-center justify-start
            gap-[20px]'>
          ...
          <div className='w-[90%] h-[400px] flex flex-col items-center justify-center
            ...
            {!show && <IoEyeOutline className='w-[20px] h-[20px] cursor-pointer absolute right-[35%] bottom-[47%]'
              onClick={() => setShow(prev => !prev)} />}
            {show && <FaRegEyeSlash className='w-[20px] h-[20px] cursor-pointer absolute right-[35%] bottom-[47%]'
              onClick={() => setShow(prev => !prev)} />}
