          ...
          flex-col gap-[40px] py-[100px]'>
            ...
            <div className='flex items-center justify-start gap-[50px] flex-col md:flex-row'>
              ...
              backdrop:blur-lg md:text-[25px] text-[20px] border-[1px] border-[#969595] '>
                Total No. Of Products: <sapn className='px-[20px] py-[10px] bg-[#030e11]
                rounded-lg flex items-center justify-center border-[1px] border-[#969595]'
                >{totalProducts}</sapn>
              </div>
           <div className='text-[#dcfafd] w-[400px] max-w-[90%] h-[200px] bg-[#0000002e]
              flex items-center justify-center flex-col gap-[20px] rounded-lg shadow-sm shadow-black
              backdrop:blur-lg md:text-[25px] text-[20px] border-[1px] border-[#969595] '>
                Total No. Of Orders: <sapn className='px-[20px] py-[10px] bg-[#030e11]
                rounded-lg flex items-center justify-center border-[1px] border-[#969595]'
                >{totalOrders}</sapn>
              </div>              
            </div>
